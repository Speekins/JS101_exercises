/*SOLUTION: The function randomly chooses and returns an array. The + operator is used to concatenate the arrays
resulting in conjoined strings. When .join() method is called on the string, this throws an error.
Use Array.prototype.concat() instead.*/
