...
//Split the string into an array in which each word is an element - .split(' ')
//Iterate over the array
//Check the length of the word using .length
//Return the word concatenated with a space and the length of the word
